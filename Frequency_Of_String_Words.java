// Java implementation to countd the frequency of each words in a string
...
public class Frequency_Of_String_Words {
	...
	public static void main(String[] args) {
		String str = "the day is sunny the the the sunny is is good good good good good good";
